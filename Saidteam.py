...
cl = LINETCR.LINE()
cl.login(token="EncjfROpCgqGkGX9f9Zc.ueLeCJvKvdpbtVTadGiEla.a928c1AcndYm+JXdn5+SQIgDCzN7aprVnX0/iGTOWKw=")

ki = LINETCR.LINE()
ki.login(token="EnJx4IWN4G7rbFRd9Lva.TtmrXEUy+dQxPJqjuRhwUG.Rq21pfiw/5i9z4qMOUrNyJN7/mKJlX+4r1E1h3DUINU=")

kk = LINETCR.LINE()
kk.login(token="EnngzMBMgW01dZHnMjz4.K4ZdSmCEofQe1bhu08sm1a.G7SHUt0ejODSIL/3itsBNjzPWNs+OFEY93YCSkdB4B8=")

kc = LINETCR.LINE()
kc.login(token="EntvszSdlH2KreQrCkkb.Gl2FmoVBdJvP5zrS8+WsIW.oIYSggORO2opTjtSdUN+v7IceST90x3NbarwEijdvuU=")

ks = LINETCR.LINE()
ks.login(token="EnuheAlkXv7GkJz7TQW2.KxA6VUcUn6EFFRwvPDwx8G.9t/7AQ/BVirbL6Uh78D43PmsmyFCGEZZhELGcRzXSTU=")

kt = LINETCR.LINE()
kt.login(token="Enw6WAj6cBlXuC8qBWrf.yPnXfbQBXwUcAf9xdQZTVW.CF7kyWVVx3i5q/+/omB5KioAIib2aFtSKfaoLrETLEc=")

print "T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ X҉̶̥͕̮̠̦͉̑̉̄̀̚ H҉̶͚̖̜̍̃͐Δ̶Ҝ̶β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊"
reload(sys)
...
=======================
  ✩★ALL COMMANDS★✩
=======================\n
★ T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ X҉̶̥͕̮̠̦͉̑̉̄̀̚ H҉̶͚̖̜̍̃͐Δ̶Ҝ̶β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊ ★
● S1 rename:[text]
● S2 rename:[text]
● S3 rename:[text]
● S4 rename:[text]
...
owner = ["u5049447235645433c14efb400e021e2c"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#==================================================
              ...
              if msg.from_ in owner:
                string = msg.text.replace("S1 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = cl.getProfile()
                    profile.displayName = string
                    cl.updateProfile(profile)
              ...
              if msg.from_ in owner:
                string = msg.text.replace("S2 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
              ...
              if msg.from_ in owner:
                string = msg.text.replace("S3 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = kc.getProfile()
                    profile.displayName = string
                    kc.updateProfile(profile)
            ...
            elif "S5 rename:" in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("S5 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ks.getProfile()
                    profile.displayName = string
                    ks.updateProfile(profile)
                    ks.sendText(msg.to,"change name: "+string+"\nsucces")
            elif "S6 rename:" in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("S6 rename:","")
                if len(string.decode('utf-8')) <= 20:
                    profile = kt.getProfile()
                    profile.displayName = string
                    kt.updateProfile(profile)
...
#------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                kt.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Success recover")
	      ...
	      if msg.from_ in admin:
                ...
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
#========================================
            elif msg.text in ["S1 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["S2 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["S3 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["S4 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["S5 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["S6 backup run"]:
                if msg.from_ in admin:
...
#---------------FUNGSI RATAIN GRUP TANPA KICK SESAMA BOT/Admin/Bots----------#
                ...
                if msg.toType == 2:
                    ...
                    gs = ks.getGroup(msg.to)
                    gs = kt.getGroup(msg.to)
                    kk.sendText(msg.to,"(explosion  KILLING ALL MEMBER 􂀁􀄃explosion)")
...
#============================================
            ...
            elif msg.text.lower() in ["mentionall"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
